        ...
        try:
            ...
            if user.status == "kicked":
             ...
             await StreamBot.send_photo(
                ...
                caption="<i>𝗝ᴏɪɴ 𝗠ʏ 𝗖ʜᴀɴɴᴇʟ 𝗧ᴏ 𝗨sᴇ 𝗧ʜɪs 𝗕ᴏᴛ ❤️‍🔥</i>",
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("♻️ 𝗝ᴏɪɴ 𝗡ᴏᴡ ♻️", url=f"https://t.me/{Var.UPDATES_CHANNEL}")
                        ]
                    ]
                ),
...
<b> I also support Channels, add me to you Channel and send any media files and see miracle✨ also send /list to know all commands""",
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("💁‍♂️ DEV", url="https://github.com/KingPhoenix06")],
                [InlineKeyboardButton("💥 Source Code", url="https://github.com/KingPhoenix06/Filestreambot-pro")]
            ]
        )
    )
