...
async def private_receive_handler(c: Client, m: Message):
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            await c.send_message(
                chat_id=m.chat.id,
                text="""<i>𝗝ᴏɪɴ 𝗠ʏ 𝗖ʜᴀɴɴᴇʟ 𝗧ᴏ 𝗨sᴇ 𝗧ʜɪs 𝗕ᴏᴛ ❤️‍🔥</i>""",
    ...
    try:
        ...
        await m.reply_text(
            ...
            quote=True,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("𝗦ᴛʀᴇᴀᴍ 🖥", url=stream_link), #Stream Link
                                                InlineKeyboardButton('𝗗ᴏᴡɴʟᴏᴀᴅ 📥', url=online_link)]]) #Download Link
        )
